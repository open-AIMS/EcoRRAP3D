...
Title: Chain 1 Local Processing DSLR
...
#IN LINES 121, 124 BELOW: Alignment quality = Lowest
...
scalebar_error_threshold = 0.01 # Threshold for scale bar error
#IN LINES 314, 316 BELOW: minimum number of scalebars: 3
