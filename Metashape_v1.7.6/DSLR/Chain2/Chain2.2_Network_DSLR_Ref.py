...
Title: Chain 2.2 Network-Adapted DSLR - REFERENCE MODELS ONLY
Last edited: 25.11.2024
User input/checks required: Input path to 'SparseCloudClean_DSLR.py' script and check network server address is correct.

Script description:
Chain 2.2 Network processing. For use in the office/access to network processing for REFERENCE ONLY models.
Before running the script, the full photo set needs to be imported, Chain 1 must be complete, QAQC OK, and Chain 2.1 completed with correct region placement
